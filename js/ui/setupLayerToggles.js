...
export function setupToggle(map, checkboxId, layerIds, applyZoomLock, applyLegendVisibility, ensure) {
...
export function setupLayerToggles(map, originalMinZoom, setCurrentZoomLock, applyLegendVisibility) {
  ...
  const ctx = { zoomLock, applyLegendVisibility, updateLegendVisibilityByZoom, ensure: (id) => ensureEntry(map, id) };
