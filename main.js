...
try {
  ...
  const publicConfig = await import('./config.public.js');
  MAPTILER_API_KEY = publicConfig.MAPTILER_API_KEY;
  MAPILLARY_TOKEN = publicConfig.MAPILLARY_TOKEN;
}
...
map.on("load", () => {
  ...
  function updateLayerFilter() {
    ...
    // ✅ NEU: Beteiligungsfilter hinzufügen
